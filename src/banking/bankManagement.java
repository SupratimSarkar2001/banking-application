...
public class bankManagement implements bankManagementDao {
    // provides all bank method

    private static final int NULL = 0;

    static Connection con = connection.getConnection();
    static String sql = "";
    public boolean createAccount(String name, int passCode) {
        try {
    ...
    public  boolean loginAccount(String name, int passCode) // login method
    {
        try {
            // validation
            if (name == "" || passCode == NULL) {
    ...
    public void getBalance(int acNo) // fetch balance method
    {
        try {
    ...
    public  boolean transferMoney(int sender_ac, int reveiver_ac, int amount) throws SQLException // transfer money method
    {
        // validation
